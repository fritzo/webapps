...
// TODO highlight livecoder-only keywords & variables
...
CodeMirror.defineMode("live", function(config, parserConfig) {
  var live = /^\b(vars|run|clear|using|help|print|error|assert|assertEqual|assertEval|assertLength|TODO)\b/;
  var liveLang = /^\b(vars|run|clear|using)\b/;
